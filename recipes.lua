...
local cooking_recipes = {
    {0.34, "technic_many_machines:brass_dust_small", "technic_many_machines:brass_nugget"},
    {0.34, "technic_many_machines:bronze_dust_small", "technic_many_machines:bronze_nugget"},
    {0.34, "technic_many_machines:carbon_steel_dust_small", "technic_many_machines:carbon_steel_nugget"},
    {0.34, "technic_many_machines:cast_iron_dust_small", "technic_many_machines:cast_iron_nugget"},
    {0.34, "technic_many_machines:chromium_dust_small", "technic_many_machines:chromium_nugget"},
    {0.34, "technic_many_machines:copper_dust_small", "technic_many_machines:copper_nugget"},
    {0.34, "technic_many_machines:gold_dust_small", "technic_many_machines:gold_nugget"},
    {0.34, "technic_many_machines:lead_dust_small", "technic_many_machines:lead_nugget"},
    {0.34, "technic_many_machines:mithril_dust_small", "technic_many_machines:mithril_nugget"},
    {0.34, "technic_many_machines:silver_dust_small", "technic_many_machines:silver_nugget"},
    {0.34, "technic_many_machines:stainless_steel_dust_small", "technic_many_machines:stainless_steel_nugget"},
    {0.34, "technic_many_machines:tin_dust_small", "technic_many_machines:tin_nugget"},
    {0.34, "technic_many_machines:wrought_iron_dust_small", "technic_many_machines:wrought_iron_nugget"},
    {0.34, "technic_many_machines:zinc_dust_small", "technic_many_machines:zinc_nugget"},
}
